        ...
        $settings = $this->get_settings_for_display();
            ...
            echo '
                <div id="wrap-countdown" class="countdown-wrapper">
                    ...
                    <div class="countdown-item"><span id="domHrs" class="countdown-digits countdown-hours">--</span><span class="countdown-label">ชั่วโมง</span></div>
                    <div class="countdown-item"><span id="domMin" class="countdown-digits countdown-minutes">--</span><span class="countdown-label">นาที</span></div>
                    <div class="countdown-item"><span id="domSec" class="countdown-digits countdown-seconds">--</span><span class="countdown-label">วินาที</span></div>
