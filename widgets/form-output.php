...
class FormOutput extends Widget_Base{
  ...
  protected function _register_controls(){
    ...
    $this->add_group_control(
      ...
      [
          'name' => 'form-output-heading',
          'selector' => '{{WRAPPER}} .form-output h3',
          'separator'		=> 'after'
      ]
  );
  $this->add_responsive_control(
    ...
    [
      ...
      'selectors' => [
        '{{WRAPPER}} .form-output h3' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
      ],
    ]
      );
  ...
  $this->start_controls_section(
    ...
    $this->add_group_control(
      Group_Control_Typography::get_type(),
      [
          'name' => 'form-output-text',
          'selector' => '{{WRAPPER}} .form-output',
          'separator'		=> 'after'
      ]
  );
    ...
    protected function render() {
        ...
        echo '<div class="columns form-output -promotion">
                <div class="column pro" id="form-output-pro"></div>
                <div class="column discount" id="form-output-discount"></div>
              </div>';

        // user
        echo '<div class="columns form-output -info">
                <div class="column" >
                  <div class="heading">
                  ...
                  <ul>
                    <li id="form-output-name"></li>
                    <li id="form-output-phone"></li>
                  </ul>
                </div>
              </div>';

        // share button
        echo '<div class="columns form-output -share">
                  <div class="column">
                    <div class="heading">
